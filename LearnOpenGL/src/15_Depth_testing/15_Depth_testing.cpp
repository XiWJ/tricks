...
int main()
{
    ...
    */
    ...
    // 构建 & 编译 shader
    std::string cube_vert_path = fs::current_path().string() + "\\..\\..\\..\\..\\src\\15_Depth_testing\\Shaders\\vert.glsl";
    std::string cube_frag_path = fs::current_path().string() + "\\..\\..\\..\\..\\src\\15_Depth_testing\\Shaders\\frag.glsl";
    ...
    // 生成纹理
    std::string cube_image_path = fs::current_path().string() + "\\..\\..\\..\\..\\src\\15_Depth_testing\\Textures\\marble.jpg";
    std::string plane_image_path = fs::current_path().string() + "\\..\\..\\..\\..\\src\\15_Depth_testing\\Textures\\metal.png";
