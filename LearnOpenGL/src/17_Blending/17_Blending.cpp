...
int main()
{
    ...
    */
    ...
    // 开启半透明混合模型
    /*
    Color_res = Color_src * alpha_src + Color_dst * (1 - alpha_src)
    GL_SRC_ALPHA -- alpha_src
    GL_ONE_MINUS_SRC_ALPHA -- 1 - alpha_src
    */
    glEnable(GL_BLEND);
    glBlendFunc(GL_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA);

    // 构建 & 编译 shader
    std::string cube_vert_path = fs::current_path().string() + "\\..\\..\\..\\..\\src\\17_Blending\\Shaders\\vert.glsl";
    std::string cube_frag_path = fs::current_path().string() + "\\..\\..\\..\\..\\src\\17_Blending\\Shaders\\frag.glsl";
    ...
    std::vector<glm::vec3> windows // transparet位置
    {
    ...
    // 生成纹理
    std::string cube_image_path = fs::current_path().string() + "\\..\\..\\..\\..\\src\\17_Blending\\Textures\\marble.jpg";
    std::string plane_image_path = fs::current_path().string() + "\\..\\..\\..\\..\\src\\17_Blending\\Textures\\metal.png";
    std::string transparent_image_path = fs::current_path().string() + "\\..\\..\\..\\..\\src\\17_Blending\\Textures\\blending_transparent_window.png";
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // 记录每个不透明物体到相机距离，map会按照key值从小到大排序
