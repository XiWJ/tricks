...
def frame_to_world(opt):
    ...
    RGBA[0, :][depth!=0] = (0xff & color[:, 0][depth!=0]) << 16 | (0xff & color[:, 1][depth!=0]) << 8 | (0xff & color[:, 0][depth!=0])
...
if __name__ == '__main__':
    ...
    parser.add_argument('--depth_path',
                        ...
                        default='/media/xwj/Planar/ScanNet/2d_data/scene0369_00/depth', type=str)
    parser.add_argument('--color_path',
                        help='seg data folder',
                        default='/media/xwj/Planar/ScanNet/2d_data/scene0369_00/color', type=str)
    parser.add_argument('--save_dir',
                        help='ply data folder',
                        default='/media/xwj/Planar/ScanNet/2d_data/scene0369_00/ply', type=str)
    ...
    parser.add_argument('--pose_path',
                        help='pose data folder',
                        default='/media/xwj/Planar/ScanNet/2d_data/scene0369_00/pose', type=str)
