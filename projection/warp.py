...
if __name__ == '__main__':
    image1 = cv2.imread("/home/xiweijie/github/zmvsnet/rect_001_0_r5000.png").astype(np.float32)
    image2 = cv2.imread("/home/xiweijie/github/zmvsnet/rect_002_0_r5000.png").astype(np.float32)
    intrinsics1, extrinsics1 = read_cam_file("/home/xiweijie/github/zmvsnet/00000000_cam.txt")
    intrinsics2, extrinsics2 = read_cam_file("/home/xiweijie/github/zmvsnet/00000001_cam.txt")
    depth1 = np.array(read_pfm("/home/xiweijie/github/zmvsnet/depth_map_0000.pfm")[0], dtype=np.float32)
    depth2 = np.array(read_pfm("/home/xiweijie/github/zmvsnet/depth_map_0001.pfm")[0], dtype=np.float32)
    ...
    cv2.imwrite("/home/xiweijie/github/zmvsnet/warp.png", np.uint8(warpped_src_img))